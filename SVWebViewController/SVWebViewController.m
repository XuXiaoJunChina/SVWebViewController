...
- (void)viewDidLoad {
    ...
    UIProgressView *progressView = [[UIProgressView alloc]initWithFrame:CGRectMake(0, 0, deviceWidthe, 3)];
    progressView.progressTintColor = [UIColor greenColor];
    
    [self.view addSubview:progressView];
//    [self.view insertSubview:progressView aboveSubview:self.mainWebView];
...
{
    //    [webViewProgress setProgress:progress animated:NO];
